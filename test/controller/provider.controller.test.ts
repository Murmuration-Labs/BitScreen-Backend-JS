...
describe('Provider Controller: PUT provider', () => {
  ...
  it('Should throw error for incorrect sent update information (config missing)', async () => {
    const req = getMockReq({
      body: {
        identificationKey: 'loginEmail',
        identificationValue: testEmail,
  ...
  it('Should throw error for incorrect sent update information (provider not on object)', async () => {
    const req = getMockReq({
      body: {
        identificationKey: 'loginEmail',
        identificationValue: testEmail,
